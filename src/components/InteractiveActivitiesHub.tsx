...
export const InteractiveActivitiesHub: React.FC<InteractiveActivitiesHubProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Teacher instruction banner + Danh sách thẻ chọn hoạt động: chỉ hiện khi mở từ menu Hoạt Động trên cùng (xem tất cả).
          Khi mở từ nút "Hoạt Động Tiết N" ngay trên slide thì ẩn hẳn phần này vì đã tự động vào đúng hoạt động rồi, tránh trùng lặp. */}
      {!filterActivityId && (
        <>
