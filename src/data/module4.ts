...
export const module4: Lesson[] = [
  {
    ...
    slides: [
      ...
      },
      {
        ...
        speakerNotes: 'Củng cố yêu cầu cần đạt 12.C3.MR1, đặt vấn đề cho buổi học sau: làm thế nào để cải thiện độ chính xác của mô hình.'
      },
      {
  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        speakerNotes: 'Nội dung này đạt yêu cầu cần đạt 12.C2.MR1 - học sinh học cách tùy chỉnh hệ thống AI để phù hợp với mục tiêu cụ thể của nhóm.'
      },
      {
      ...
      },
      {
        ...
        content: [
          '✅ Đã đạt yêu cầu cần đạt: 12.C2.1; 12.C2.MR1; 12.C3.1; 12.C3.MR1.',
