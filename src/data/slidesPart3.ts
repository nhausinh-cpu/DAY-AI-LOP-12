        ...
        data: [
          {
            ...
            desc: 'Hiểu vòng đời 7 bước và nguyên tắc con người quyết định cuối cùng',
            icon: 'CheckCircle',
            color: 'blue',
          },
          {
            ...
            desc: 'Thực thi 6 nguyên tắc, trách nhiệm giải trình và liêm chính học thuật',
            icon: 'CheckCircle',
            color: 'amber',
          },
          {
            id: 'cert_3',
            tag: 'Mạch C Đạt',
            title: 'Kĩ Thuật & Đánh Giá',
            desc: 'Thành thạo công cụ AI không code và kiểm thử bằng dữ liệu mới',
            icon: 'CheckCircle',
            color: 'emerald',
          },
          {
            ...
            desc: 'Hợp tác nhóm tạo ra sản phẩm AI chạy được và báo cáo thành công',
            icon: 'CheckCircle',
            color: 'purple',
          },
        ],
